...
int main(){
	...
	for(i=0;i<num;i++){
		...
		fflush(stdin);
		printf("\n%i. Nombre del Empleado:	", i+1); gets(empleados[i].nombre);
	...
	for(i=0;i<num;i++) {
		printf("\n%i. Nombre del Empleado:	%s", i+1, empleados[i].nombre);
		printf("\n%i. Direccion:	%s", i+1, empleados[i].dir_empleado.direccion);
		printf("\n%i. Ciudad:	%s", i+1, empleados[i].dir_empleado.ciudad);
		printf("\n%i. Provincia:	%s", i+1, empleados[i].dir_empleado.provincia);
		printf("\n%i. Salario:	%.2lf", i+1, empleados[i].salario);
		printf("\n");
