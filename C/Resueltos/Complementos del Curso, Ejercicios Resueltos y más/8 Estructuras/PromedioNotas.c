// 2 estructuras Promedio: nota1,2,3
// alumno: nombre sexo edad, (struct promedio anidada
// Pedir datos alumno, calcular promedio, imprimir todos los datos incluido promedio
#include<stdio.h>
#include<stdlib.h>
...
int main(){
	...
	*/
	...
	printf("\n Edad del alumno:		%i",alumno1.edad);
	
		printf("\n Nota1:	%.2f",alumno1.prom.nota1);
		printf("\n Nota2:	%.2f",alumno1.prom.nota2);
		printf("\n Nota3:	%.2f", alumno1.prom.nota3);
			printf("\n\n Nota Media:	%.2f", media);
